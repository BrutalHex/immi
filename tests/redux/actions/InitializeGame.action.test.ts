...
import { MailArchiverThunkResult, MailArchiverThunkDispatch } from '../../../src/base/BaseTypes';
import { InitializeGame } from '../../../src/Pages/Play/MailArchiverPageAction';
import {
  creatAction,
  ActoinTypes,
  Initialize_APP,
...
const mockStore = configureStore<RootState, MailArchiverThunkDispatch>(middlewares);
